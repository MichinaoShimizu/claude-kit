...
[作業記録と保守報告「保守報告の作業単位」](../.agents/skills/verify-docs/references/work-records-and-report.md#保守報告の作業単位)を参照。
...
記述形式と運用ルールの正本は
[references/document-size-exceptions.md](../.agents/skills/verify-docs/references/document-size-exceptions.md)を参照する。
