...
| 役割 | 配布元 | 配布先 |
| --- | --- | --- |
| 検査CLI | `packages/verify-docs/scripts/` | `.verify-docs/scripts/` |
| 既定設定 | `packages/verify-docs/config/verify-docs.config.json` | `.verify-docs/config/verify-docs.config.json` |
| TODO | `packages/verify-docs/config/verify-docs.todo.json` | `.verify-docs/config/verify-docs.todo.json` |
