...
| 連続空行の冗長化 | 2行以上連続する空行。Markdown上は1行の空行と同じ意味になる | — |
| 強調記法の二重掛け | 太字と斜体を同じ語句に重ねて使っている箇所。片方の記法だけで強調は伝わる | 「\*\*_強調_\*\*」→「\*\*強調\*\*」 |
| リンクテキストのURL再掲 | リンクテキストがURL文字列そのものの繰り返しになっている箇所 | 「[https://example.com](https://example.com)」→「\<https://example.com\>」 |
