...
削除・結合・言い換えによって意味、対象読者、条件、手順の順序、免責文言のいずれかを
保てると確信できない場合は、変更せずに作業を止めて利用者に質問する。質問には、
候補箇所へのリンク、削減案、失われるおそれがある内容、変更する場合と残す場合の影響を
含める。回答があるまで候補を是正済みにせず、保守報告へ統合しない。
